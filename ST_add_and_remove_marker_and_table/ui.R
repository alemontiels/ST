...
navbarPage(inverse=TRUE,title=div(img(src="capsus.png", height=30, width=80,align="center")), id="nav",
    ...
    HTML ('<h3><strong> <p align="center">Health sector</p></strong></h3>'),
      ...
      # Actualizar el tipo de mapa elegido
      actionButton("update", "Update Map"),
    
    # Para agregar y borrar marcadores de Hospitales
      HTML ('<h3><strong> <p align="center">Add and Clear markers</p></strong></h3>'),
